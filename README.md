...
This is a personal academic site constructed with [Nesta](http://nestacms.com/ "Nesta").  It started with various hacks to the Nesta website itself, but has gradually evolved away.  The site is hosted on [Fly.io](https://fly.io/ "Fly.io") and can be accessed at [https://bweslake.org/](https://bweslake.org/ "https://bweslake.org/").  For more, see this [note](https://bweslake.org/blog/a-note-on-this-site "A Note on This Site").
